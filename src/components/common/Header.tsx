    ...
    return (
        <header className=" py-3 px-12">
            <nav className="container mx-auto flex justify-between items-center">
             ...
             text-primary shadow-[0px 4px 4px rgba(0,0,0,0.25)]">{labels.douty}</h1>
                    </div>
                </Link>
                <div className="space-x-6 font-bold">
                    <Link href="/products" className="font-poppins  leading-[36px] 
             teext-base shadow-[0px 4px 4px rgba(0,0,0,0.25)]">
                        {labels.features}
                    </Link>
                    <Link href="/cart" className="font-poppins leading-[36px] teext-base shadow-[0px 4px 4px rgba(0,0,0,0.25)]">
                        {labels.howItworks}
                    </Link>
                </div>
            </nav>
